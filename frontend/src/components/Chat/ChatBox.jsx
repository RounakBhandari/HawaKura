...
export const ChatBox = () => {
    ...
    const { selectedChat, user, activeUsers } = useChatState();
    ...
    const isPartnerOnline = partner && activeUsers 
        ? activeUsers.some(id => id.toString() === partner._id.toString()) 
        : false;
        ...
        <div className="flex-1 flex flex-col h-full">
          ...
          <div className="p-4 border-b border-slate-800 bg-slate-900/40 backdrop-blur-md flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {/* 3. Wrap the avatar and the dot in a relative div so the dot positions correctly */}
              ...
              <div>
                ...
                <span className={`text-[10px] font-medium ${isPartnerOnline ? 'text-emerald-400' : 'text-slate-500'}`}>
